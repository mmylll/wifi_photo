...
import 'package:wifi_photo/views/send_photo_page.dart';
...
senderRequestDialog(BuildContext context, String username, String os, String path) async {
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) {
                      return SendPhotoPage(path: path,
                      );
                    },
                  ),
                );
