...
import 'package:wifi_photo/components/snackbar.dart';
import 'package:wifi_photo/controllers/controllers.dart';
import 'package:wifi_photo/services/photon_receiver.dart';
...
import '../receive_photo_page.dart';
                              ...
                              child: Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    String path = (await FileMethods.getSavePath(snap.data[item], widget.senderModel!))
                                        .replaceAll(r'\', '/');
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) {
                                          return ReceivePhotoPage(path: path,senderModel: widget.senderModel!
                                          );
                                        },
                                      ),
                                    );
